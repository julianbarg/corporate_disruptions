...
```{r read}
library(feather)
recalls_matched <- read_feather('shiny_data/recalls_matched 2019-04-18.feather')
...
19 out of the 40 remaining observations only have non-zero values, leaving us with only 21 observations (companies) with variance.